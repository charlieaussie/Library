...
class ConnectionPool(queue.Queue):
    ...
    def add_connection(self, cnx=None):
        ...
        if not cnx:
            ...
            if tuple(int(n) for n in ver.split("-")[0].split(".")) > (8, 0, 10):
...
class PoolsManager(object):
    ...
    def _pool_exists(self, client_id, pool_name):
        ...
        return any(pool.name == pool_name for pool in pools)
    ...
    def _get_pools(self, settings):
        ...
        pool_names = [router_name for router_name, _ in connections_settings]
        return [
            pool
...
class Session(object):
    ...
    def _init_attributes(self):
        ...
        client_license = "GPL-2.0" if license_chunks[0] == "GPLv2" else "Commercial"
        default_attributes = {
            "_pid": str(os.getpid()),

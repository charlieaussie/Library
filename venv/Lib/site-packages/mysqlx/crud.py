...
class Schema(DatabaseObject):
    ...
    def get_table(self, name, check_existence=False):
        ...
        if check_existence and not table.exists_in_database():
    ...
    def get_view(self, name, check_existence=False):
        ...
        """
        view = View(self, name)
        if check_existence and not view.exists_in_database():
    ...
    def get_collection(self, name, check_existence=False):
        ...
        if check_existence and not collection.exists_in_database():

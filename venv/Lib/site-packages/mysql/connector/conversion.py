...
class MySQLConverterBase(object):
    ...
    def set_charset(self, charset):
        ...
        if charset == 'utf8mb4':
            charset = 'utf8'
        self.charset = charset if charset is not None else 'utf8'
...
class MySQLConverter(MySQLConverterBase):
    ...
    def escape(self, value):
        ...
        """
        if value is None or isinstance(value, NUMERIC_TYPES):
            return value
    ...
    def _unicode_to_mysql(self, value):
        ...
        if charset_id in CharacterSet.slash_charsets and b'\x5c' in encoded:
